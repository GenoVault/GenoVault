  ...
  "instructions": [
    ...
    },
    {
      ...
      "docs": [
        ...
        "створений через CPI, не буває більшим за 10 КіБ. При `RECIPE_BATCH = 4`",
        "буфер у цю межу вміщається, тож дорощувань немає — інструкція лишається",
        "на випадок, коли стеля Arcium дозволить більший батч."
      ],
      "discriminator": [
        76,
        232,
